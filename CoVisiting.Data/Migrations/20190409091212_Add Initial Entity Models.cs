        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AfterEventId = table.Column<int>(nullable: true),
                    BeforeEventId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Moving_AfterEventId",
                        column: x => x.AfterEventId,
                        principalTable: "Moving",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Events_Moving_BeforeEventId",
                        column: x => x.BeforeEventId,
                        principalTable: "Moving",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventReplies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventReplies_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_AfterEventId",
                table: "Events",
                column: "AfterEventId");

            migrationBuilder.CreateIndex(
                name: "IX_Events_BeforeEventId",
                table: "Events",
                column: "BeforeEventId");
